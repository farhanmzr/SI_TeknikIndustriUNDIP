...
<body style="background-color : #fafafa;"> <br><br>
    ...
    <div class="col-md-2" align="left">
        <ul class="nav" id="main-menu">
            <br>
            <li>
                <a href="dosen_mahasiswa.php"><i class="fa fa-user fa-2x"></i>Mahasiswa</a>
            </li>
            <li>
                <a href="dosen.php"><i class="fa fa-user fa-2x"></i>Dosen</a>
            </li>
             <li>
                <a class="active-menu" a href="dosen_join.php"><i class="fa fa-user fa-2x"></i>Daftar Mahasiswa KP</a>
            </li>
            <li>
