...
<body style="background-color : #fafafa;"> <br><br>
    ...
    <div class="col-md-2" align="left">
        <ul class="nav" id="main-menu">
            <br>
            <li>
                <a href="koorkp_mahasiswa.php"><i class="fa fa-user fa-2x"></i>Mahasiswa</a>
            </li>
            <li>
                <a class="active-menu" href="koorkp_dosen.php"><i class="fa	fa-user	fa-2x"></i>Dosen</a>
            </li>
             <li>
                <a href="koorkp_join.php"><i class="fa fa-user fa-2x"></i>Daftar Mahasiswa KP</a>
            </li>
            <li>
                          ...
                          if (isset($_POST['find'])) {
                            ...
                            if ($cari == "") {
                              ...
                              <tr>
                                ...
                                <td><a href='edit_dosen.php?id=<?php echo $row['id']; ?>' class='btn btn-success'>
                                    <span class='glyphicon glyphicon-edit'></span>Edit</button></a>
                                    <a href='hapus_dosen.php?id=<?php echo $row['id']; ?>' class='btn btn-danger'>
